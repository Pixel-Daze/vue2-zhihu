<template>
	<div class="slider" :class="{'slider-cursor':click}" @mouseover="pause && pausePlay()" @mouseout="pause && goPlay()" :style="{'width': `${this.width}px`, 'height': `${this.height}px`}">
		<div class="slider-item-list" :style="{'width': `${this.count * 100}%`, 'left': `${-100 * this.current}%`, transitionDuration: `${this.speed}s`}">
